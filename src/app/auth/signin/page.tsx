  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm">
        <div className="bg-card border border-border rounded-2xl p-8 shadow-premium text-center space-y-6">
          <div className="mx-auto bg-primary text-primary-foreground p-3 rounded-xl w-fit">
            <BookOpen className="h-8 w-8" />
          </div>
          <div>
            <h1 className="text-xl font-bold tracking-tight">Internal Knowledge Base</h1>
